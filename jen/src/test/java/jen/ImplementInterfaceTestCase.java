/* ImplementInterfaceTestCase.java - Awaiting description
 *
...
public class ImplementInterfaceTestCase extends TestCase
{
  // Deprecated to save warnings (DemoClass is annotated with Deprecated) 
  @Deprecated
  public void testCanImplementInterface() throws Exception {
    SoftClass sc = new SoftClass(DemoClass.class);
    sc.setName("jen.tests.NewClass01");
    
    // it already has a run() method, but isn't runnable
    sc.addInterface("java.lang.Runnable");
