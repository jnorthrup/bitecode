...
/** 
 * Constraint that requires a comparable be less than another
 * comparable.
 *
 * @author Ross Bamford (rosco&lt;at&gt;roscopeco.co.uk)
...
public class CompLess extends Constraint
{
   ...
   * logically 'less than' the predicate. This constructor throws 
   * NPE if passed <code>null</code>.
   * 
   * @param predicate The predicate for this constraint.
   */
  public CompLess(Comparable predicate) {
  ...
  public StringBuilder describe(StringBuilder buffer) {
    return buffer.append("less than ").append(predicate);    
  }      
}
