 ...
 */
public class StartsWith extends Constraint
{
   ...
   * <code>null</code>.
   */
  public StartsWith(CharSequence predicate) {
  ...
  public boolean eval(Object o) {
    ...
    return ((CharSequence)o).toString().startsWith(predicate);
  }
  
  public StringBuilder describe(StringBuilder buffer) {
    return buffer.append("starting with \"").append(predicate).append("\"");    
  }    
}
