...
public class CompEqual extends Constraint
{
  ...
  public StringBuilder describe(StringBuilder buffer) {
    return buffer.append("equal to ").append(predicate);    
  }      
}
