 ...
 */
public class Smaller extends SizeConstraint
{
  final long than;
   ...
   */
  public Smaller(long than) {
    if (than < 0) throw new IllegalArgumentException("You want 'CompLess'");
    this.than = than;
  }
  ...
  public StringBuilder describe(StringBuilder buffer) {
    return buffer.append("smaller than ").append(than).append(" element(s)");    
  }      
}
