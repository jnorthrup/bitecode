 ...
 * ExceptionTableHeaderVisitor#Utf8Index(ByteBuffer, int[], IntBuffer)}</td></tr> <tr><td>AttributeLength</td><td>0x4</td><td>0x2</td><td>
 * (int) AttributeLength=src.getInt(0x2)</td><td>{@link ExceptionTableHeaderVisitor#AttributeLength(ByteBuffer, int[],
 * IntBuffer)}</td></tr> <tr><td>ExceptionsCount</td><td>0x2</td><td>0x6</td><td> (short)
 * ExceptionsCount=src.getShort(0x6) & 0xffff</td><td>{@link ExceptionTableHeaderVisitor#ExceptionsCount(ByteBuffer,
 * int[], IntBuffer)}</td></tr>
 *
 * @see inc.glamdring.bitecode.ExceptionTableHeader#Utf8Index
 * @see inc.glamdring.bitecode.ExceptionTableHeader#AttributeLength
 * @see inc.glamdring.bitecode.ExceptionTableHeader#ExceptionsCount </table>
 */
