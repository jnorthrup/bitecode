...
/**
 * <p>recordSize: 1048634 <table><tr> <th>name</th><th>size</th><th>seek</th><th>Value Class</th><th>Sub-Index</th></tr>
 * <tr><td>ConstantPoolRecord</td><td>0x3a</td><td>0x0</td><td> (byte) ConstantPoolRecord=src.get(0x0) &
 * 0xff</td><td>{@link inc.glamdring.bitecode.ConstantPoolRecord}</td></tr> <tr><td>interfaces</td><td>0x40000</td><td>0x3a</td><td>
 * (byte) interfaces=src.get(0x3a) & 0xff</td><td>{@link TableRecordVisitor#interfaces(ByteBuffer, int[],
 * IntBuffer)}</td></tr> <tr><td>fields</td><td>0x40000</td><td>0x4003a</td><td> (byte) fields=src.get(0x4003a) &
 * 0xff</td><td>{@link TableRecordVisitor#fields(ByteBuffer, int[], IntBuffer)}</td></tr>
 * <tr><td>methods</td><td>0x40000</td><td>0x8003a</td><td> (byte) methods=src.get(0x8003a) & 0xff</td><td>{@link
 * TableRecordVisitor#methods(ByteBuffer, int[], IntBuffer)}</td></tr> <tr><td>attributes</td><td>0x40000</td><td>0xc003a</td><td>
 * (byte) attributes=src.get(0xc003a) & 0xff</td><td>{@link TableRecordVisitor#attributes(ByteBuffer, int[],
 * IntBuffer)}</td></tr>
 *
 ...
 * @see inc.glamdring.bitecode.TableRecord#attributes </table>
 */
