 ...
 * InterfaceMethod_Visitor#ClassIndex(ByteBuffer, int[], IntBuffer)}</td></tr> <tr><td>NameAndTypeIndex</td><td>0x2</td><td>0x2</td><td>
 * (short) NameAndTypeIndex=src.getShort(0x2) & 0xffff</td><td>{@link InterfaceMethod_Visitor#NameAndTypeIndex(ByteBuffer,
 * int[], IntBuffer)}</td></tr>
 *
 * @see inc.glamdring.bitecode.InterfaceMethod_#ClassIndex
 * @see inc.glamdring.bitecode.InterfaceMethod_#NameAndTypeIndex </table>
 */
