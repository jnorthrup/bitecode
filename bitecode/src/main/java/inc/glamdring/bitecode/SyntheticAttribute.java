 ...
 * SyntheticAttributeVisitor#Utf8Index(ByteBuffer, int[], IntBuffer)}</td></tr> <tr><td>AttributeLength</td><td>0x4</td><td>0x2</td><td>
 * (int) AttributeLength=src.getInt(0x2)</td><td>{@link SyntheticAttributeVisitor#AttributeLength(ByteBuffer, int[],
 * IntBuffer)}</td></tr>
 *
 * @see inc.glamdring.bitecode.SyntheticAttribute#Utf8Index
 * @see inc.glamdring.bitecode.SyntheticAttribute#AttributeLength </table>
 */
