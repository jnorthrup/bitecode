...
InnerClassInfoIndex</th><td>2</td><td>0</td><td>{@link java.nio.ByteBuffer}</td></tr><tr><th>

OuterClassInfoIndex</th><td>2</td><td>0</td><td>{@link java.nio.ByteBuffer}</td></tr><tr><th>

inner_nameIndex</th><td>2</td><td>0</td><td>{@link java.nio.ByteBuffer}</td></tr><tr><th>

AccessFlagsValue</th><td>2</td><td>0</td><td>{@link inc.glamdring.bitecode.classfile.structure.AccessFlagsValue}</td></tr> *
...
;
	...
	InnerClassInfo()	{		 if(  isRecord &&subRecord == null) 		if (subRecord == null) {
		    try {
	...
	static void index(ByteBuffer src, int[] register, IntBuffer stack) {
		for (InnerClassInfo InnerClassInfo : values()) {
		    String hdr = InnerClassInfo.name();
		    System.err.println("hdr:pos " + hdr + ':' + stack.position());
		    InnerClassInfo.subIndex(src, register, stack);
		}
	}
