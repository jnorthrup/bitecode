 ...
 * <p>recordSize: 8
 * <table><tr>
 * <th>name</th><th>size</th><th>seek</th><th>Value Class</th><th>Sub-Index</th></tr> * <tr><td> Utf8Index</td><td>2</td><td>0</td><td>short Utf8Index src.{@link java.nio.ByteBuffer#getShort}(0) & 0xffff</td><td>{@link ExceptionTableHeaderVisitor#Utf8Index(ByteBufferer, int[], IntBuffer)}</td></tr>
 * <tr><td> AttributeLength</td><td>2</td><td>2</td><td>short AttributeLength src.{@link java.nio.ByteBuffer#getShort}(2) & 0xffff</td><td>{@link ExceptionTableHeaderVisitor#AttributeLength(ByteBufferer, int[], IntBuffer)}</td></tr>
 * <tr><td> ExceptionsCount</td><td>2</td><td>6</td><td>short ExceptionsCount src.{@link java.nio.ByteBuffer#getShort}(6) & 0xffff</td><td>{@link ExceptionTableHeaderVisitor#ExceptionsCount(ByteBufferer, int[], IntBuffer)}</td></tr>
 *
