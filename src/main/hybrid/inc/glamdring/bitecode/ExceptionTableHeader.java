 ...
 * <tr><td> Utf8Index</td><td>0x2</td><td>0x0</td><td> (short) Utf8Index=src.{@link java.nio.ByteBuffer#getShort}(0x0) & 0xffff</td><td>{@link ExceptionTableHeaderVisitor#Utf8Index(ByteBufferer, int[], IntBuffer)}</td></tr>
 * <tr><td> AttributeLength</td><td>0x4</td><td>0x2</td><td> (int) AttributeLength=src.{@link java.nio.ByteBuffer#getInt}(0x2)</td><td>{@link ExceptionTableHeaderVisitor#AttributeLength(ByteBufferer, int[], IntBuffer)}</td></tr>
 * <tr><td> ExceptionsCount</td><td>0x2</td><td>0x6</td><td> (short) ExceptionsCount=src.{@link java.nio.ByteBuffer#getShort}(0x6) & 0xffff</td><td>{@link ExceptionTableHeaderVisitor#ExceptionsCount(ByteBufferer, int[], IntBuffer)}</td></tr>
 * 
