 ...
 * <tr><td>AttributeLength</td><td>0x4</td><td>0x2</td><td> (int) AttributeLength=src.getInt(0x2)</td><td>{@link AttributeHeaderVisitor#AttributeLength(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
