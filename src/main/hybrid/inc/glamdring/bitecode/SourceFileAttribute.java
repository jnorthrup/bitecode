 ...
 * <tr><td> Utf8Index</td><td>0x2</td><td>0x0</td><td> (short) Utf8Index=src.{@link java.nio.ByteBuffer#getShort}(0x0) & 0xffff</td><td>{@link SourceFileAttributeVisitor#Utf8Index(ByteBufferer, int[], IntBuffer)}</td></tr>
 * <tr><td> AttributeLength</td><td>0x4</td><td>0x2</td><td> (int) AttributeLength=src.{@link java.nio.ByteBuffer#getInt}(0x2)</td><td>{@link SourceFileAttributeVisitor#AttributeLength(ByteBufferer, int[], IntBuffer)}</td></tr>
 * <tr><td> sourcefileIndex</td><td>0x2</td><td>0x6</td><td> (short) sourcefileIndex=src.{@link java.nio.ByteBuffer#getShort}(0x6) & 0xffff</td><td>{@link SourceFileAttributeVisitor#sourcefileIndex(ByteBufferer, int[], IntBuffer)}</td></tr>
 * 
