 ...
 * <p>recordSize: 4
 * <table><tr>
 * <th>name</th><th>size</th><th>seek</th><th>Value Class</th><th>Sub-Index</th></tr> * <tr><td> ClassIndex</td><td>2</td><td>0</td><td>short ClassIndex src.{@link java.nio.ByteBuffer#getShort}(0) & 0xffff</td><td>{@link InterfaceMethod_Visitor#ClassIndex(ByteBufferer, int[], IntBuffer)}</td></tr>
 * <tr><td> NameAndTypeIndex</td><td>2</td><td>2</td><td>short NameAndTypeIndex src.{@link java.nio.ByteBuffer#getShort}(2) & 0xffff</td><td>{@link InterfaceMethod_Visitor#NameAndTypeIndex(ByteBufferer, int[], IntBuffer)}</td></tr>
 *
 * @see inc.glamdring.bitecode.InterfaceMethod_#ClassIndex
 * @see inc.glamdring.bitecode.InterfaceMethod_#NameAndTypeIndex
 * </table>
 */
