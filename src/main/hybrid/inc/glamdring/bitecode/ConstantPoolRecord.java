 ...
 * <tr><td> ConstantPoolRef</td><td>0x22</td><td>0x0</td><td> (byte) ConstantPoolRef=src.get(0x0) & 0xff</td><td>{@link inc.glamdring.bitecode.ConstantPoolRef}</td></tr>
 * <tr><td> subType</td><td>0x2</td><td>0x22</td><td> (short) subType=src.getShort(0x22) & 0xffff</td><td>{@link ConstantPoolRecordVisitor#subType(ByteBuffer, int[], IntBuffer)}</td></tr>
 * <tr><td> utf8Bitmap</td><td>0x1</td><td>0x24</td><td> (byte) utf8Bitmap=src.get(0x24) & 0xff</td><td>{@link ConstantPoolRecordVisitor#utf8Bitmap(ByteBuffer, int[], IntBuffer)}</td></tr>
 * <tr><td> tag</td><td>0x1</td><td>0x25</td><td> (byte) tag=src.get(0x25) & 0xff</td><td>{@link ConstantPoolRecordVisitor#tag(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
