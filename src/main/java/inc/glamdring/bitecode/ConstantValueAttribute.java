 ...
 * ConstantValueAttributeVisitor#Utf8Index(ByteBuffer, int[], IntBuffer)}</td></tr>
 * <tr><td>AttributeLength</td><td>0x4</td><td>0x2</td><td> (int) AttributeLength=src.getInt(0x2)</td><td>{@link
 * ConstantValueAttributeVisitor#AttributeLength(ByteBuffer, int[], IntBuffer)}</td></tr>
 * <tr><td>constantvalueIndex</td><td>0x2</td><td>0x6</td><td> (short) constantvalueIndex=src.getShort(0x6) &
 * 0xffff</td><td>{@link ConstantValueAttributeVisitor#constantvalueIndex(ByteBuffer, int[], IntBuffer)}</td></tr>
 *
 ...
 * @see inc.glamdring.bitecode.ConstantValueAttribute#constantvalueIndex </table>
 */
