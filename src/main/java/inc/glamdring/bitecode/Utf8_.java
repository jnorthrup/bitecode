 ...
 * <tr><td> length</td><td>0x2</td><td>0x0</td><td>shortlength src.{@link java.nio.ByteBuffer#getShort}(0) & 0xffff</td><td>{@link Utf8_Visitor#length(ByteBufferer, int[], IntBuffer)}</td></tr>
 * 
