 ...
 * <tr><td> Utf8Index</td><td>0x2</td><td>0x2</td><td> (short) Utf8Index=src.getShort(0x2) & 0xffff</td><td>{@link FieldInfoHeaderVisitor#Utf8Index(ByteBuffer, int[], IntBuffer)}</td></tr>
 * <tr><td> DescriptorIndex</td><td>0xffffffff</td><td>0x4</td><td> (byte) DescriptorIndex=src.get(0x4) & 0xff</td><td>{@link FieldInfoHeaderVisitor#DescriptorIndex(ByteBuffer, int[], IntBuffer)}</td></tr>
 * <tr><td> attributes_count</td><td>0x2</td><td>0x3</td><td> (short) attributes_count=src.getShort(0x3) & 0xffff</td><td>{@link FieldInfoHeaderVisitor#attributes_count(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
