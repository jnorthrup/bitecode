 ...
 * SourceFileAttributeVisitor#Utf8Index(ByteBuffer, int[], IntBuffer)}</td></tr> <tr><td>AttributeLength</td><td>0x4</td><td>0x2</td><td>
 * (int) AttributeLength=src.getInt(0x2)</td><td>{@link SourceFileAttributeVisitor#AttributeLength(ByteBuffer, int[],
 * IntBuffer)}</td></tr> <tr><td>sourcefileIndex</td><td>0x2</td><td>0x6</td><td> (short)
 * sourcefileIndex=src.getShort(0x6) & 0xffff</td><td>{@link SourceFileAttributeVisitor#sourcefileIndex(ByteBuffer,
 * int[], IntBuffer)}</td></tr>
 *
 * @see inc.glamdring.bitecode.SourceFileAttribute#Utf8Index
 * @see inc.glamdring.bitecode.SourceFileAttribute#AttributeLength
 * @see inc.glamdring.bitecode.SourceFileAttribute#sourcefileIndex </table>
 */
