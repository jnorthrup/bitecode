 ...
 * <tr><td> Utf8Index</td><td>0x2</td><td>0x0</td><td>shortUtf8Index src.{@link java.nio.ByteBuffer#getShort}(0) & 0xffff</td><td>{@link SourceFileAttributeVisitor#Utf8Index(ByteBufferer, int[], IntBuffer)}</td></tr>
 * <tr><td> AttributeLength</td><td>0x2</td><td>0x2</td><td>shortAttributeLength src.{@link java.nio.ByteBuffer#getShort}(2) & 0xffff</td><td>{@link SourceFileAttributeVisitor#AttributeLength(ByteBufferer, int[], IntBuffer)}</td></tr>
 * <tr><td> sourcefileIndex</td><td>0x2</td><td>0x6</td><td>shortsourcefileIndex src.{@link java.nio.ByteBuffer#getShort}(6) & 0xffff</td><td>{@link SourceFileAttributeVisitor#sourcefileIndex(ByteBufferer, int[], IntBuffer)}</td></tr>
 * 
