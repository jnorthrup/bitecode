 ...
 * NameAndType_Visitor#Utf8Index(ByteBuffer, int[], IntBuffer)}</td></tr> <tr><td>DescriptorIndex</td><td>0x2</td><td>0x2</td><td>
 * (short) DescriptorIndex=src.getShort(0x2) & 0xffff</td><td>{@link NameAndType_Visitor#DescriptorIndex(ByteBuffer,
 * int[], IntBuffer)}</td></tr>
 *
 * @see inc.glamdring.bitecode.NameAndType_#Utf8Index
 * @see inc.glamdring.bitecode.NameAndType_#DescriptorIndex </table>
 */
